    ...
    <main className="pt-20">
        ...
        <div className="max-w-3xl">
          ...
          <Reveal delay={0.2}>
            <h1 className="text-4xl md:text-6xl font-serif text-white mb-8 leading-tight">
              ...
              <span className="italic text-[#c8a96e]">A Heart-to-Heart Approach.</span>
            </h1>
          </Reveal>
          <Reveal delay={0.3}>
      ...
      <SectionWrapper bg="secondary">
        <div className="grid md:grid-cols-3 gap-12">
          <MethodologyCard 
            icon={<HeartHandshake className="text-[#c8a96e]" size={32} />}
            title="Mind & Heart"
          ...
          />
          <MethodologyCard 
            icon={<Laptop className="text-[#c8a96e]" size={32} />}
            title="Digital First"
          ...
          />
          <MethodologyCard 
            icon={<Globe2 className="text-[#c8a96e]" size={32} />}
      ...
      <SectionWrapper bg="primary">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="border-t border-white/10 pt-16">
            <Reveal>
              <h3 className="text-[#c8a96e] uppercase tracking-widest text-sm mb-8">The Pathway</h3>
            </Reveal>
      ...
      {/* ── Transparent Rates (From your Flyer) ── */}
      <SectionWrapper bg="secondary">
        <div className="max-w-4xl mx-auto bg-[#0a0a0a] border border-[#c8a96e]/20 p-8 md:p-16 relative">
          <div className="absolute top-0 right-0 p-4">
             <Sparkles className="text-[#c8a96e]/20" size={64} />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white/5 p-8 border border-white/5 text-center group hover:border-[#c8a96e]/40 transition-colors">
              <h4 className="text-white/60 text-sm uppercase mb-2">Children (5-18 Yrs)</h4>
              <p className="text-4xl font-serif text-[#c8a96e]">$30<span className="text-lg text-white/40">/hour</span></p>
            ...
            <div className="bg-white/5 p-8 border border-white/5 text-center group hover:border-[#c8a96e]/40 transition-colors">
              ...
              <p className="text-4xl font-serif text-[#c8a96e]">$40<span className="text-lg text-white/40">/hour</span></p>
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <div className="flex items-center justify-center gap-2 text-white/40 text-xs uppercase tracking-widest">
                <Clock size={14} /> Flexibile Scheduling
              </div>
            </div>
          </div>
        </div>
...
function MethodologyCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <Reveal>
      <div className="p-8 border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors">
  ...
  return (
    <Reveal>
      <div className="flex gap-6 group">
        <span className="text-[#c8a96e] font-serif text-2xl opacity-40 group-hover:opacity-100 transition-opacity">
          {number}
        </span>
        <div>
